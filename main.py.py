...
def check_password_strength(*args):
    ...
    # Dynamic UI UI Updates based on score evaluation
...
root = tk.Tk()
root.title("Decode Labs - Password Shield")
...
lbl_brand = tk.Label(root, text="DECODE LABS", font=("Courier", 12, "bold"), bg="#0a192f", fg="#64ffda")
lbl_brand.pack(pady=(25, 5))
